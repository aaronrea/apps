 ...
 *   3. Team logos from ESPN's CDN: cache-first, filled in as they are seen. A
 ...
 *   4. The schedule API: never cached here. It is content, not shell, and the
 ...
 *
 * Bump SHELL_CACHE when the shell layout here changes, so the old one is
 * dropped on activate; day-to-day code changes no longer need it, rule 1
 * covers them. LOGO_CACHE is deliberately left alone across those bumps — the
 * logos are still good.
 * ------------------------------------------------------------------------- */

const SHELL_CACHE = 'slate-shell-v4';
